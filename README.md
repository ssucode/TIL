...
> Today I Learned
### 작성법
* 폴더 또는 파일명은 영문으로하며, [프로그래밍 표기법(Programming Naming Rules)](https://github.com/ssucode/TIL/blob/main/Etc/namingRules.md) 기준으로 한다.
...
#### Rules
* [프로그래밍 표기법(Programming Naming Rules)](https://github.com/ssucode/TIL/blob/main/Etc/namingRules.md)
